...
<head>
    <title>Safety {{ $Suzuki->getMerk() }}</title>
    <meta charset='utf-8'>
        ...
        <nav class="navbar navbar-expand-sm bg-primary navbar-dark fixed-top">
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <div class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ url('/safety') }}">Fitur Safety</a>
                    </li>
                </div>
            </div>
        </nav>
    ...
    <body>
        <div class="container">
            <div class="jumbotron text-center" style="margin-top:60px">
                <h1>Fitur Safety {{ $Suzuki->getMerk();}}</h1>
            </div>
            <table class="table table-striped table-bordered table-hover table-dark">
              <tbody>
                <tr>
                    <td>Airbag System</td>
                    <td>{{$Suzuki->getAirbagsystem();}}</td>
                </tr>
                <tr>
                    <td>Anti Theft System</td>
                    <td>{{$Suzuki->getAntitheft();}}</td>
                </tr>
                <tr>
                    <td>Engine Immobilizer</td>
                    <td>{{$Suzuki->getEngineimmobilizer();}}</td>
                </tr>
                <tr>
                    <td>Child Safety Locks</td>
                    <td>{{$Suzuki->getChildlock();}}</td>
                </tr>
                <tr>
                    <td>Sensor Parkir</td>
                    <td>{{$Suzuki->getSensorparkir();}}</td>
                </tr>
              </tbody>
            </table>
        </div>
